<section class="antialiased">
            ...
            <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                <div class="w-full md:w-1/2">
                    <form class="flex items-center">
                        <label for="simple-search" class="sr-only">Search category</label>
                    ...
                    <tbody>
                        @foreach ($categories as $category)
                            <tr class="border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-3">
                                    <div class="p-2 w-fit rounded-md" style="background-color: {{ $category->color }}">
                                        {{ $category->color }}
                                    </div>
                                </td>
                                <td class="px-4 py-3 flex items-center justify-end">
                                    <button
                                        id="category-{{ $category->id }}-dropdown-button"
                                    ...
                                    >
                                        <ul
                                            class="py-1 text-sm"
                                            aria-labelledby="category-{{ $category->id }}-dropdown-button"
                                        >
                                            <li>
                                                <button
                                                    id="updateCategoryModalButton"
                                                    data-modal-target="updateCategoryModal-{{ $category->id }}"
                                    ...
                                    <x-categories.update-modal :category="$category" />
                                    <div
    ...
    @if (Session::has("success"))
        <div
            ...
            class="absolute right-5 bottom-5 w-full max-w-sm p-4"
        >
            <div
                id="toast-success"
